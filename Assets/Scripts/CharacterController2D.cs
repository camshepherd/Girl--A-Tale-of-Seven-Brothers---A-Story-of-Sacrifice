...
public class CharacterController2D : MonoBehaviour
{
  ...
  //  [SerializeField] private Transform m_CeilingCheck;                          // A position marking where to check for ceilings
    ...
    public float boostModifier = 1.9f;
    private bool boosted = false;
    private float boostTimer = 0;
    private float boostEnd = 0;
    private float m_JumpForceModifier = 1.0f;
    ...
    public void Move(float move, bool crouch, bool jump)
    {
        ...
        if (m_Grounded && jump)
        {
            ...
            m_Grounded = false;
            m_Rigidbody2D.AddForce(new Vector2(0f, m_JumpForce * m_JumpForceModifier));
        }
    }
    ...
    public void boost(float duration)
    {
        ...
        boostTimer = 0;
        boosted = true;
        m_JumpForceModifier = boostModifier;
    }
    ...
    IEnumerator respawn()
    {
        ...
        GetComponent<Inventory>().refillWater();
